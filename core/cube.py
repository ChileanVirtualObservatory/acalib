...
class Cube(nd.NDData):
    ...
    def __init__(self,data,meta):
        ...
        mask=np.isnan(data)
        sunit=meta['BUNIT']
        # Hack to correct wrong units generated by CASA
        sunit=sunit.replace("JY","Jy")
        sunit=sunit.replace("BEAM","beam")
        unit=u.Unit(sunit,format="fits")
        
        # Call super constructur
        super(nd.NDData,self).__init__(data,None,mask,None,None,meta,unit)

        print "NAXIS =",meta['NAXIS']
        for i in range(1,meta['NAXIS']):
           print "Axis",i
