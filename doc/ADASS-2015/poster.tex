...
intent to be a coherent framework for developing webservices for the Chilean 
Virtual Observatory (ChiVO), but it offers a generic API for developing
stand-alone applications. The algorithms automatically connects to VO services,
and the library is compatible with the SAMP protocol for interacting with other
applications like Topcat and Aladin.
		\end{minipage} \hfill
